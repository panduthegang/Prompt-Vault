...
// Rich sorting options utilizing the CustomSelect component
...
// ============================================================================
// 2. REUSABLE CREATOR CARD (Used for mobile default & desktop grid)
// ============================================================================
...
// ============================================================================
// 3. MAIN ADMIN USERS COMPONENT (Clean View-Only)
// ============================================================================
  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col space-y-6 min-w-0 w-full pb-24 lg:pb-0">
        ...
        {/* ==================================================================== */}
        {/* 3. SEARCH, BESPOKE SELECT DROPDOWN & VIEW SWITCHER TOOLBAR           */}
        {/* ==================================================================== */}
        ...
        {filteredUsers.length === 0 ? (
          ...
          <>
            {/* 4A. MOBILE VIEW: Always Render Clean Cards (Zero squished tables on small screens) */}
            ...
            {/* 4B. DESKTOP/TABLET VIEW: Table View or Cards Grid depending on user selection */}
                ...
                <section className="bg-vault-cream rounded-[26px] p-6 border-2 border-vault-dark/15 shadow-xs space-y-4">
                  <div className="flex items-center justify-between pb-2 border-b border-vault-dark/10">
                    ...
                    <span className="font-mono text-xs text-vault-dark/60">
                      Ranked by {SORT_OPTIONS.find((s) => s.value === sortBy)?.label.toUpperCase()}
                    </span>
                  </div>
