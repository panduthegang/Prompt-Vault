          ...
          <div className="bg-vault-cream border-2 border-vault-dark rounded-[24px] sm:rounded-[28px] max-w-lg w-full p-5 sm:p-7 space-y-5 shadow-2xl relative my-8">
            ...
            <div className="flex items-center justify-between border-b-2 border-vault-dark/15 pb-4">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full border border-vault-dark/20 flex items-center justify-center hover:bg-vault-dark/10 transition-colors cursor-pointer"
              >
            ...
            <form onSubmit={handleSaveItem} className="space-y-4">
              ...
              <div className="pt-2 flex items-center justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-5 py-2.5 rounded-full border-2 border-vault-dark text-vault-dark font-sans text-xs font-bold hover:bg-vault-yellow/40 cursor-pointer transition-colors"
                >
                  Cancel
                </button>
                <button
