...
export default function Comparison({ className = '' }: ComparisonProps) {
  return (
    <section
      id="comparison"
      className={`w-full bg-vault-cream text-vault-dark py-16 sm:py-20 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 border-t-2 border-vault-dark scroll-mt-20 ${className}`}
    >
