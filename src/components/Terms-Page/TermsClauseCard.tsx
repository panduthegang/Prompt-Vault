...
import { TermsClause } from './termsData';

export interface TermsClauseCardProps {
  clause: TermsClause;
  isOpen: boolean;
  onToggle: () => void;
}

export default function TermsClauseCard({ clause, isOpen, onToggle }: TermsClauseCardProps) {
  return (
    <article
      id={clause.id}
